    ...
    <main className=" min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex justify-center items-center">
      <section className="lg:flex">
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a href="https://www.webmotors.com.br/sedans" target="_blank" className="font-lexend block w-fit bg-offwhitebg px-10 py-3 rounded-3xl text-orange">Ver Mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a href="https://www.webmotors.com.br/suvs" target="_blank" className="font-lexend block w-fit bg-offwhitebg px-10 py-3 rounded-3xl text-green">Ver Mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a href="https://www.webmotors.com.br/carros-de-luxo" target="_blank" className="font-lexend block w-fit bg-offwhitebg px-10 py-3 rounded-3xl text-dark-green">Ver Mais</a>
        </div>
      </section>
    </main>
  )
